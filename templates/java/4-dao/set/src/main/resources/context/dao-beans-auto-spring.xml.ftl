...
<#list tableConfigSet.tableConfigs as tableConfig>
    <bean id="${tableConfig.className?uncap_first}${dao_name_suffix}" class="${tableConfig.basepackage}.${dao_dir_name}.${impl_dir_name}.${tableConfig.className}${dao_name_suffix}${impl_name_suffix}" parent="abstractDaoSupport" />
</#list>
