...
${typeHandlers}
    ...
    <sqlMap resource="sqlmap/mapping/_common-sqlmap-mapping-${systemName}.xml" />
    <#list tableConfigSet.tableConfigs as tableConfig>
    <sqlMap resource="sqlmap/mapping/${tableConfig.className}-sqlmap-mapping-${systemName}.xml" />
    </#list>
</sqlMapConfig>
