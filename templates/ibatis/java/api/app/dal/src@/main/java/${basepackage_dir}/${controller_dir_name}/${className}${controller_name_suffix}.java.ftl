...
<#list tableConfig.sqls as sql>
	...
	public <@generateResultClassName sql pojo_name_suffix/> ${sql.operation}(
        ...
        PageList<${className}> ${className?uncap_first}List = this.${className?uncap_first}Service.get${className}PageList(${className?uncap_first}, pagination.getPageSize(), pagination.getPage());
