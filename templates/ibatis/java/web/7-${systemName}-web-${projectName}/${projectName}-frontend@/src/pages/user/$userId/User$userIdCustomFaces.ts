...
import {User$userIdState} from '@i/interfaces/User$userIdFaces';

export const user$userIdCustomState = {

}

export interface User$userIdCustomSubscriptions extends Subscriptions {

}

export interface User$userIdCustomEffects extends Effects {

}

export interface User$userIdCustomReducers extends Reducers<User$userIdState> {
