...
8. 我使用过一段时间支付宝的dalgen,被其深深的理念所折服，很难再回到之前的mybatis-gernerator搞原始开发，我也无法接受在java文件上里混入sql的开发理念（hibernate就是这样失去市场的??）。加上很幸运地taocode关闭前找到badqiu的dalgen。工欲善其事,必先利其器,所以才有今天的dalgenX
